...
const KeyboardShortcutConfigurator: React.FC<KeyboardShortcutConfiguratorProps> = ({ actionText = '', platform, shortcut, shortcutName }) => {
    ...
    return (
      <>
        ...
        <span className='keyCommand' aria-labelledby={labelId}>
          {[...modifierKeys, shortcutKey].map((displayKey: string, index: number, displayKeys: string[]) =>
