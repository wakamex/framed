...
const svgIcons: Record<string, any> = {
  ...
  octicon: (name: string, settings: { height: number }) => <Octicon icon={getIconByName(name)} height={settings.height} />
}
