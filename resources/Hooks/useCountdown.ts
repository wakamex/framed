...
const useCountdown = (targetDate: string | number | Date): string => {
  ...
  return isFinite(countDownDate.getTime()) ? toString(countDown) : 'INVALID DATE'
}

const toString = (countdown: number): string => {
